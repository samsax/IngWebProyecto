...
public interface EmpleadoDao {
	/**
	 * Firma del m�todo que nos permite obtener todos los empleados.
	 * 
	...
	/**
	 * Firma del m�todo que nos permite crear un nuevo empleado.
	 * 
	 * @param empleado
	...
	/**
	 * Firma del m�todo que nos permite eliminar un empleado de la base de datos. 
	...
	/**
	 * Firma del método para retornar el administrador de solicitudes
	 * @return
	 */
